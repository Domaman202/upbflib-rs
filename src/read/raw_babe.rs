...
impl RawReaderBigAlignedBigEndian {
    pub fn read<'a>(reader: &'a UPBFReader, file_type: UPBFType, file_version: UPBFVersion) -> Result<UPBFReadResult<'a>, UPBFReaderError> {
        ...
        let mut offset = u64_to_usize(u64::from_be_bytes(offset), UPBFReaderDataFormatReadError::InvalidOffset.into())?;
        ...
        while offset != 0 {
            ...
            let next_offset = u64_to_usize(u64::from_be_bytes(next_offset), UPBFReaderDataFormatReadError::InvalidOffset.into())?;
